...
class LineChartWidget2 extends StatefulWidget {
  ...
  const LineChartWidget2({Key? key,required this.isData1Hover, required this.isData2Hover}) : super(key: key);

  @override
  State<LineChartWidget2> createState() => _ChartState();
}

class _ChartState extends State<LineChartWidget2> {
  final List<double> Data1 = [30, 32, 35, 38, 28, 45, 42, 105, 95];
  final List<double> Data2 = [10, 25, 30, 35, 45, 35, 32, 50, 40];
  final List<double> Data3 = [20, 10, 5, 3, 10, 10, 10, 55, 55];
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      Text(
                                        'Regular Count: ${Data2[tooltipIndex!].round()}',
                                        style: GoogleFonts.manrope(
                                          color: Colors.white,
                                          fontSize: 12,
                                        ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      Text(
                                        'Irregular Count: ${Data3[tooltipIndex!].round()}',
                                        style: GoogleFonts.manrope(
                                          color: Colors.white,
                                          fontSize: 12,
                                        ),
...
class ChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint line3Paint = Paint()
      ..color = isData2Hover ? Color.fromARGB(255, 246, 144, 144) : Color.fromARGB(255, 228, 76, 76)
      ..strokeWidth = 2
      ..style = PaintingStyle.stroke;
    ...
    final Paint areaPaint3 = Paint()
      ..color = isData3Hover ? Color.fromARGB(255, 246, 144, 144).withOpacity(0.1) : Color.fromARGB(255, 228, 76, 76).withOpacity(0.5)
      ..style = PaintingStyle.fill;  

    drawLine(canvas, size, Data1, line1Paint, areaPaint1);
    drawLine(canvas, size, Data2, line2Paint, areaPaint2);
    drawLine(canvas, size, Data3, line3Paint, areaPaint3);
    ...
    if (tooltipIndex != null) {
      ...
      final double y3 =
          size.height - (Data3[tooltipIndex!] / 110 * size.height);
      ...
      canvas.drawCircle(
        Offset(x, y3),
        5,
        Paint()..color = Color.fromARGB(255, 228, 76, 76),
      );
    }
  }
